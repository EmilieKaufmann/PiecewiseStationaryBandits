...
# the choice of parameters given in this example correspond to Problem 1 of [Besson et al. 20] with T=20000 and N=100 repetitions 
...
# TYPE OF EXPERIMENT
Type = "Frequentist" # Frequentist or Bayesian experiment?
...
# CUSTOM NON-STATIONARY PROBLEM (if you didn't choose one of the default names) 
...
# TWEAK 
tweak = 1 # multiplicative constant in front of the exploration parameter alpha for all CDP-based algorithms
